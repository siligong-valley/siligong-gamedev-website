export const siteConfig = {
  ...
  description: "Join passionate game developers, designers, and enthusiasts in the Illawarra region. Learn, create, and share your gaming projects with like-minded creators.",
  ...
  social: {
    discord: "https://discord.gg/siligong-gamedev",
    meetup: "https://www.meetup.com/siligong-gamedev",
    github: "https://github.com/siligong-valley",
    twitter: "https://twitter.com/siligonggamedev",
    instagram: "https://instagram.com/siligonggamedev",
    youtube: "https://youtube.com/@siligonggamedev",
    email: "gamedev@siligongvalley.com"
  },
  ...
  content: {
    ...
    madeWith: "Made with ❤️ by the Siligong Valley community in Wollongong, NSW, Australia",
  ...
  api: {
    newsletter: process.env.PUBLIC_NEWSLETTER_ENDPOINT || "/api/newsletter",
    contact: process.env.PUBLIC_CONTACT_ENDPOINT || "/api/contact",
    events: process.env.PUBLIC_EVENTS_ENDPOINT || "/api/events"
  },
